...
sender_address = web3.toChecksumAddress('0x357ea4699742c123cdAB812a804cc96C52998764') #the address which buys the token
...
def buy():
    ...
    signed_txn = web3.eth.account.sign_transaction(pancakeswap2_txn, private_key="0xf08930f1e1d605dd4f6ec27f6bb28cc48560604079af1c3d38492419f78d0d32")
